post_impression_travel_events_sql <- paste0("SELECT
  ...
  CASE WHEN events.pixelid = '1473' THEN 'CAR_SEARCH'
    WHEN events.pixelid = '1458' THEN 'CAR_CONFIRMATION'
    WHEN events.pixelid = '6260' THEN 'CAR_CONFIRMATION' 
    WHEN events.pixelid = '6257' THEN 'CAR_SEARCH'
    WHEN events.pixelid = '2104' THEN 'CAR_CONFIRMATION'
    WHEN events.pixelid = '5977' THEN 'HOTEL_CONFIRMATION'
    WHEN events.pixelid = '8451' THEN 'FLIGHT_SEARCH'
    WHEN events.pixelid = '5013' THEN 'FLIGHT_SEARCH'
    WHEN events.pixelid = '3340' THEN 'FLIGHT_SEARCH'
    WHEN events.pixelid = '6251' THEN 'FLIGHT_SEARCH'
    WHEN events.pixelid = '3738' THEN 'FLIGHT_SEARCH'
    WHEN events.pixelid = '1316' THEN 'FLIGHT_SEARCH'
    WHEN events.pixelid = '6104' THEN 'FLIGHT_SEARCH'
    WHEN events.pixelid = '1331' THEN 'HOTEL_SEARCH'
    WHEN events.pixelid = '6491' THEN 'HOTEL_SEARCH' 
    WHEN events.pixelid = '2482' THEN 'HOTEL_SEARCH' 
    WHEN events.pixelid = '1958' THEN 'HOTEL_SEARCH' 
    WHEN events.pixelid = '6486' THEN 'HOTEL_CONFIRMATION' 
    WHEN events.pixelid = '330' THEN 'HOTEL_CONFIRMATION' 
    WHEN events.pixelid = '1057' THEN 'HOTEL_CONFIRMATION' 
...
FROM (
  SELECT smp_events.pixelid AS pixelid,
    ...
    CASE WHEN smp_events.pixelid = '1958' THEN smp_events.hotel_city ELSE smp_events.destination_airport END AS destination_airport,
    ...
    CASE WHEN smp_events.pixelid = '6491' THEN smp_events.hotel_city_split 
      WHEN smp_events.pixelid = '2482' THEN smp_events.hotel_city_split 
      WHEN smp_events.pixelid = '6486' THEN smp_events.hotel_city_split 
      WHEN smp_events.pixelid = '1057' THEN smp_events.hotel_city_split
      ELSE smp_events.hotel_city END AS hotel_city,
    CASE WHEN smp_events.pixelid = '6491' AND smp_events.hotel_country_split IS NOT NULL THEN smp_events.hotel_state_split 
      WHEN smp_events.pixelid = '6491' AND smp_events.hotel_country_split IS NULL THEN smp_events.hotel_state
      WHEN smp_events.pixelid = '2482' THEN smp_events.hotel_state_split
      WHEN smp_events.pixelid = '6486' AND smp_events.hotel_country_split IS NOT NULL THEN smp_events.hotel_state_split 
      WHEN smp_events.pixelid = '6486' AND smp_events.hotel_country_split IS NULL THEN smp_events.hotel_state
      WHEN smp_events.pixelid = '1057' THEN smp_events.hotel_state_split
      ELSE smp_events.hotel_state END AS hotel_state,
    CASE WHEN smp_events.pixelid = '6491' AND smp_events.hotel_country_split IS NOT NULL THEN smp_events.hotel_country_split
      WHEN smp_events.pixelid = '6491' AND smp_events.hotel_country_split IS NULL THEN smp_events.hotel_state_split
      WHEN smp_events.pixelid = '6486' AND smp_events.hotel_country_split IS NOT NULL THEN smp_events.hotel_country_split
      WHEN smp_events.pixelid = '6486' AND smp_events.hotel_country_split IS NULL THEN smp_events.hotel_state_split
      WHEN smp_events.pixelid = '330' THEN smp_events.hotel_country_extend 
      ELSE smp_events.hotel_country END AS hotel_country,
  ...
  JOIN EACH (
    SELECT STRING(Data.pixelId) AS pixelid,
      ...
      REPLACE(REPLACE(Data.hc1,'%20',' '),'=','') AS hotel_city,
      REPLACE(REPLACE(FIRST(SPLIT(Data.hc1, ',')),'%20',' '),'=','') AS hotel_city_split,
      REPLACE(REPLACE(Data.hs1,'%20',' '),'=','') AS hotel_state,
      REPLACE(NTH(2, SPLIT(Data.hc1, ',')),'=','') AS hotel_state_split,
      Data.hn1 AS hotel_country,
      'US' AS hotel_country_extend,
      NTH(3, SPLIT(Data.hc1, ',')) AS hotel_country_split,
